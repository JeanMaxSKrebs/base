...
public class Tile {
	...
	public static BufferedImage TILE_SKY = Game.spritesheet.getSprite(192, 0, 32, 32);
	public static BufferedImage TILE_GROUND = Game.spritesheet.getSprite(224, 0, 32, 32);
