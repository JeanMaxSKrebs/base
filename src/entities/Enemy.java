...
public abstract class Enemy extends Entity {
	...
	public void movimentar() {
		...
		switch (dir) {
		case 0:
			if (World.isFree(plusx, midy, "right") && !isCollidding((int) (x + speed), this.getY())) {
				moved = true;
				x += speed;
				index = 0;
			} else {
		...
		case 1:
			if (World.isFree(minusx, midy, "left") && !isCollidding((int) (x - speed), this.getY())) {
				moved = true;
				x -= speed;
				index = 1;
			} else {
		...
		case 2:
			if (World.isFree(midx, plusy, "down") && !isCollidding(this.getX(), (int) (y + speed))) {
				moved = true;
				y += speed;
				index = 2;
			} else {
		...
		case 3:
			if (World.isFree(midx, minusy, "up") && !isCollidding(this.getX(), (int) (y - speed))) {
				moved = true;
				y -= speed;
				index = 3;
			} else {
