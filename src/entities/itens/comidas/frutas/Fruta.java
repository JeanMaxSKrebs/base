...
public class Fruta extends Comida implements Comparable<Fruta> {
	...
	public static BufferedImage MACA_FR = Game.spritesheet_Fruits.getSprite(0, 64, 64, 64);
	...
	public static BufferedImage MELANCIA_FR = Game.spritesheet_Fruits.getSprite(0, 64*4, 64, 64);
