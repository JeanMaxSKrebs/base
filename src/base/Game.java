...
//		System.out.println(gameState);
		if(gameState == "NORMAL") {
			...
			if(saveGame) {
				...
				System.out.println("Nível: " + CUR_LEVEL + ", Vida: " +(int) Game.player.life + ", Estamina: " + Game.player.stamine+
...
//		//render enemies
		...
		if(gameState == "GAME_OVER") {
			...
			g.fillRect(0, 0, WIDTH*SCALE, HEIGHT*SCALE);
			g.setColor(Color.white);
			g.drawString("Parab�ns voc� Finalizou o Jogo",  WIDTH*SCALE/8, HEIGHT*SCALE/2);
			if(showMessageGameOver)
